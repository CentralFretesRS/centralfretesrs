...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Frete Fácil RS offers a modern, transport-app-style website for requesting and managing freight quotes." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Frete Fácil RS offers a modern, transport-app-style website for requesting and managing freight quotes." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Frete Fácil RS offers a modern, transport-app-style website for requesting and managing freight quotes." },
