import { r as reactExports, U as jsxRuntimeExports, T as React, $ as commonjsGlobal, P as getDefaultExportFromCjs } from "./worker-entry-Bnl8n6XV.js";
import { r as reactDomExports, t as toast, u as useNavigate } from "./router-CkvedL0f.js";
import { c as composeRefs, a as createContextScope, u as useComposedRefs, b as useId, P as Primitive, d as composeEventHandlers, e as useControllableState, f as useCallbackRef, g as Presence, h as cn, t as toDate, i as constructFrom, m as millisecondsInHour, j as millisecondsInMinute, k as createLucideIcon, R as Root2$2, l as useLayoutEffect2, n as createPopperScope, o as usePrevious, A as Anchor, p as Portal$1, q as hideOthers, r as useFocusGuards, s as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, C as Content$1, v as Arrow, w as ChevronDown, x as Check, y as supabase, L as Label$2, I as Input, B as Button, X, T as Trash2, M as MapPin, z as Calendar, E as format$1, G as ChevronLeft, H as MessageCircle, J as ChevronRight, K as Dialog, N as DialogContent, O as DialogHeader, Q as DialogTitle, S as ptBR, U as cva, V as clsx, W as startOfMonth, Y as endOfMonth, Z as Logo } from "./index-BpCLMoNv.js";
import "node:events";
...
const BellOff = createLucideIcon("bell-off", __iconNode$6);
const __iconNode$5 = [
  ["path", { d: "M10.268 21a2 2 0 0 0 3.464 0", key: "vwvbt9" }],
  [
    "path",
...
function Kanban({ onNew }) {
  const [quotes, setQuotes] = reactExports.useState([]);
  const [selected, setSelected] = reactExports.useState(null);
  const [finModal, setFinModal] = reactExports.useState(null);
  const [amount, setAmount] = reactExports.useState("");
  const [commission, setCommission] = reactExports.useState("10");
  const [pmethod, setPmethod] = reactExports.useState("pix");
  const [pstatus, setPstatus] = reactExports.useState("pendente");
  ...
  const [fOrigin, setFOrigin] = reactExports.useState("");
  const [fDestination, setFDestination] = reactExports.useState("");
  const [fDriver, setFDriver] = reactExports.useState("");
  ...
  reactExports.useEffect(() => {
    ...
    supabase.from("financials").select("driver").then(({ data }) => {
      const list = Array.from(new Set((data ?? []).map((r) => r.driver).filter(Boolean)));
      setDrivers(list);
    });
    const ch = supabase.channel("quotes-rt").on("postgres_changes", { event: "*", schema: "public", table: "quotes" }, (payload) => {
      load();
  ...
  const move = async (q, dir) => {
    const idx = COLUMNS.findIndex((c2) => c2.id === q.status);
    const next = COLUMNS[idx + dir];
    if (!next) return;
    if (next.id === "realizado") {
      setFinModal(q);
      return;
    }
  ...
  const completeFinancial = async () => {
    ...
    const { error: e22 } = await supabase.from("financials").insert({
      quote_id: finModal.id,
      client_name: finModal.client_name,
      origin: finModal.origin_city,
      destination: finModal.destination_city,
      driver: driver || null,
      amount: amt,
      commission_pct: parseFloat(commission) || 10,
      payment_method: pmethod,
      payment_status: pstatus
    });
    if (e1 || e22) {
      toast.error((e1 || e22)?.message ?? "Erro");
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-background p-3 mb-4 flex flex-wrap items-end gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-muted-foreground uppercase tracking-wider mr-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Funnel, { className: "w-3.5 h-3.5" }),
        " Filtros"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-[10px]", children: "De" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", className: "mt-1 h-8 text-xs w-[140px]", value: fFrom, onChange: (e) => setFFrom(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-[10px]", children: "Até" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", className: "mt-1 h-8 text-xs w-[140px]", value: fTo, onChange: (e) => setFTo(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-[10px]", children: "Origem" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "mt-1 h-8 text-xs w-[140px]", placeholder: "Cidade", value: fOrigin, onChange: (e) => setFOrigin(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-[10px]", children: "Destino" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "mt-1 h-8 text-xs w-[140px]", placeholder: "Cidade", value: fDestination, onChange: (e) => setFDestination(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-[10px]", children: "Motorista" }),
        drivers.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: fDriver || "all", onValueChange: (v) => setFDriver(v === "all" ? "" : v), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "mt-1 h-8 text-xs w-[140px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Todos" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "all", children: "Todos" }),
            drivers.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: d, children: d }, d))
          ] })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "mt-1 h-8 text-xs w-[140px]", placeholder: "Nome", value: fDriver, onChange: (e) => setFDriver(e.target.value) })
      ] }),
      hasFilters && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "ghost", className: "h-8 text-xs", onClick: clearFilters, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-3 h-3 mr-1" }),
        "Limpar"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4", children: COLUMNS.map((col) => {
      const cards = filtered.filter((q) => q.status === col.id);
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("rounded-2xl border-2 p-3 min-h-[300px]", col.border, col.bg), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3 px-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display text-sm tracking-wider", children: [
            col.emoji,
            " ",
            col.label.toUpperCase()
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cn("text-xs px-2 py-0.5 rounded-full font-bold", col.chip), children: cards.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          cards.map((q) => {
            const ci = COLUMNS.findIndex((c2) => c2.id === q.status);
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn("rounded-xl bg-card border p-3 hover:brightness-110 transition", col.border), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-bold text-sm truncate", children: q.client_name })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setSelected(q), className: "text-muted-foreground hover:text-primary", title: "Ver detalhes", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "w-4 h-4" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => removeQuote(q), className: "text-muted-foreground hover:text-destructive", title: "Apagar orçamento", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-4 h-4" }) })
                ] })
              ] }),
              ...
              q.desired_date && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground flex items-center gap-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3 h-3" }),
                format$1(/* @__PURE__ */ new Date(q.desired_date + "T12:00"), "dd/MM/yy", { locale: ptBR }),
                " ",
                q.period
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs mt-1 inline-block px-2 py-0.5 rounded bg-background border border-primary/30 text-primary capitalize", children: [
                q.item_category,
                q.item_quantity ? ` · ${q.item_quantity}` : ""
              ] }),
              q.item_notes && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-muted-foreground mt-1 line-clamp-2 italic", children: [
                '"',
                q.item_notes,
                '"'
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-1 mt-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", disabled: ci === 0, onClick: () => move(q, -1), className: "h-7 px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: "w-3 h-3" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `https://wa.me/${q.whatsapp.replace(/\D/g, "")}`, target: "_blank", rel: "noreferrer", className: "text-xs flex items-center gap-1 text-success hover:underline", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-3 h-3" }),
                  "WhatsApp"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", disabled: ci === COLUMNS.length - 1, onClick: () => move(q, 1), className: "h-7 px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3" }) })
              ] })
            ] }, q.id);
          }),
          cards.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground text-center py-6", children: "Sem cards" })
        ] })
      ] }, col.id);
    }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!selected, onOpenChange: (o) => !o && setSelected(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Detalhes da cotação" }) }),
      selected && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Cliente", v: selected.client_name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "WhatsApp", v: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { className: "text-success underline", href: `https://wa.me/${selected.whatsapp.replace(/\D/g, "")}`, target: "_blank", rel: "noreferrer", children: [
          selected.whatsapp,
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "inline w-3 h-3" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Origem", v: `${selected.origin_city}${selected.origin_neighborhood ? " — " + selected.origin_neighborhood : ""}${selected.origin_address ? " · " + selected.origin_address : ""}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Destino", v: `${selected.destination_city}${selected.destination_neighborhood ? " — " + selected.destination_neighborhood : ""}${selected.destination_address ? " · " + selected.destination_address : ""}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Item", v: `${selected.item_category}${selected.item_quantity ? " (" + selected.item_quantity + ")" : ""}` }),
        selected.item_notes && /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Obs item", v: selected.item_notes }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Data", v: selected.desired_date ? format$1(/* @__PURE__ */ new Date(selected.desired_date + "T12:00"), "dd/MM/yyyy") + " · " + (selected.period ?? "") : "—" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Ajudantes", v: selected.needs_helpers ? "Sim" : "Não" }),
        selected.technical_details && /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Detalhes", v: selected.technical_details })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!finModal, onOpenChange: (o) => !o && setFinModal(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { children: [
        "Concluir frete — ",
        finModal?.client_name
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "Valor (R$) *" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "mt-1", type: "number", step: "0.01", value: amount, onChange: (e) => setAmount(e.target.value) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "Comissão (%)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "mt-1", type: "number", value: commission, onChange: (e) => setCommission(e.target.value) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "Motorista" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { className: "mt-1", value: driver, onChange: (e) => setDriver(e.target.value) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "Pagamento" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: pstatus, onValueChange: setPstatus, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: completeFinancial, className: "w-full bg-gradient-brand text-white font-bold", children: "Concluir e lançar" })
      ] })
    ] }) })
  ] });
}
function Field({ label, v }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 py-1.5 border-b border-border/60", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground uppercase tracking-wider", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("col-span-2 text-sm"), children: v })
  ] });
}
...
function Financial() {
  ...
  const [from, setFrom] = reactExports.useState(format$1(startOfMonth(today), "yyyy-MM-dd"));
  const [to, setTo] = reactExports.useState(format$1(endOfMonth(today), "yyyy-MM-dd"));
  const [groupBy, setGroupBy] = reactExports.useState("date");
  const load = async () => {
    const { data, error } = await supabase.from("financials").select("*").gte("realized_at", from).lte("realized_at", to).order("realized_at", { ascending: false });
    if (error) {
      toast.error(error.message);
      return;
    }
  ...
  const totals = reactExports.useMemo(() => {
    const gross = rows.reduce((s2, r) => s2 + Number(r.amount), 0);
    const commission = rows.reduce((s2, r) => s2 + Number(r.amount) * Number(r.commission_pct) / 100, 0);
    const paid = rows.filter((r) => r.payment_status === "pago").reduce((s2, r) => s2 + Number(r.amount), 0);
  ...
  const chartData = reactExports.useMemo(() => {
    ...
    rows.forEach((r) => {
      const key = groupBy === "date" ? format$1(parseISO(r.realized_at), "dd/MM") : r[groupBy === "client" ? "client_name" : groupBy] ?? "—";
      map2.set(key, (map2.get(key) ?? 0) + Number(r.amount));
    });
    return Array.from(map2, ([name, value]) => ({ name, value })).slice(0, 20);
  }, [rows, groupBy]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 flex flex-wrap items-end gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "De" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", className: "mt-1", value: from, onChange: (e) => setFrom(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "Até" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", className: "mt-1", value: to, onChange: (e) => setTo(e.target.value) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-[160px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { className: "text-xs", children: "Agrupar por" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: groupBy, onValueChange: (v) => setGroupBy(v), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "date", children: "Data" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "origin", children: "Origem" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "destination", children: "Destino" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "driver", children: "Motorista" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "client", children: "Cliente" })
          ] })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "💰 Bruto", v: totals.gross, accent: "primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "👨‍💼 Comissões", v: totals.commission, accent: "warning" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "🔵 Recebido", v: totals.paid, accent: "info" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { label: "🟡 Pendente", v: totals.pending, accent: "warning" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-display text-sm tracking-wider mb-3", children: [
        "RECEITA POR ",
        groupBy.toUpperCase()
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 260, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: chartData, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "oklch(0.25 0.015 60)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "name", stroke: "oklch(0.68 0.02 80)", fontSize: 11 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(0.68 0.02 80)", fontSize: 11 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { contentStyle: { background: "#000000", border: "1px solid #FF8C00", borderRadius: 12 } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "value", fill: "oklch(0.74 0.18 55)", radius: [8, 8, 0, 0] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-4 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "text-xs uppercase text-muted-foreground tracking-wider", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2", children: "Data" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2", children: "Cliente" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2", children: "Trecho" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2", children: "Motorista" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right p-2", children: "Valor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right p-2", children: "Comissão" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2", children: "Pagto" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2", children: "Status" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", {})
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        rows.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-border/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: format$1(parseISO(r.realized_at), "dd/MM/yyyy", { locale: ptBR }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2 font-medium", children: r.client_name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-2 text-muted-foreground", children: [
            r.origin,
            " → ",
            r.destination
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2 text-muted-foreground", children: r.driver ?? "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-2 text-right font-bold", children: [
            "R$ ",
            Number(r.amount).toFixed(2)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-2 text-right text-muted-foreground", children: [
            "R$ ",
            (Number(r.amount) * Number(r.commission_pct) / 100).toFixed(2)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2 capitalize", children: r.payment_method }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => togglePaid(r), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: r.payment_status === "pago" ? "bg-info text-info-foreground" : "bg-warning text-warning-foreground", children: r.payment_status }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => remove(r.id), className: "text-destructive hover:opacity-70", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-4 h-4" }) }) })
        ] }, r.id)),
        rows.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 9, className: "text-center p-8 text-muted-foreground", children: "Nenhum lançamento no período" }) })
      ] })
    ] }) })
  ] });
}
function Stat({ label, v, accent }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground uppercase tracking-wider", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `font-display text-2xl mt-1 text-${accent}`, children: [
      "R$ ",
      v.toFixed(2)
    ] })
  ] });
...
function AdminPage() {
  ...
  const [notif, setNotif] = reactExports.useState(typeof Notification !== "undefined" && Notification.permission === "granted");
  ...
  if (!ready) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center text-muted-foreground", children: "Carregando..." });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 backdrop-blur-xl bg-background/80 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { size: 135 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: enableNotif, children: [
          notif ? /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-4 h-4 mr-1 text-success" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(BellOff, { className: "w-4 h-4 mr-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Notificações" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", onClick: () => supabase.auth.signOut(), children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-4 py-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-3xl mb-4", children: "Painel Gerencial" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "kanban", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "kanban", children: "Cotações" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "financial", children: "Financeiro" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "kanban", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Kanban, { onNew: ping }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "financial", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Financial, {}) })
      ] })
    ] })
  ] });
}
