...
const appCss = "/assets/styles-BegAy4F6.css";
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { theme: "dark", position: "top-right", richColors: true })
  ] });
}
const SITE = "https://centraldefretesrs.lovable.app";
...
${urls.map(
          (u) => `  <url><loc>${u.loc}</loc><lastmod>${today}</lastmod><changefreq>weekly</changefreq><priority>${u.priority}</priority></url>`
        ).join("\n")}
</urlset>`;
...
Sitemap: https://centraldefretesrs.lovable.app/sitemap.xml
`;
        return new Response(body, {
...
const $$splitComponentImporter$1 = () => import("./admin-3mm_ANhH.js");
const Route$1 = createFileRoute("/admin")({
  head: () => ({
    meta: [{
      title: "Painel — Central Fretes RS"
    }, {
      name: "robots",
      content: "noindex"
    }]
...
const $$splitComponentImporter = () => import("./index-CqyrQa5H.js");
const SERVED_CITIES = [
  // Grande Porto Alegre
  "Porto Alegre",
  "Canoas",
...
const KEYWORDS = ["frete Canoas", "mudança Canoas", "frete Porto Alegre", "mudança Porto Alegre", "frete litoral RS", "frete interior RS", "fretes compartilhados RS", "mudança residencial RS", "frete barato RS", ...SERVED_CITIES.flatMap((c) => [`frete ${c}`, `mudança ${c}`, `fretes compartilhados ${c}`])].join(", ");
const localBusinessJsonLd = {
  "@context": "https://schema.org",
  "@type": "MovingCompany",
  name: "Central Fretes RS",
  description: "Fretes e mudanças em Canoas, Porto Alegre, Grande Porto Alegre, Litoral Gaúcho, Serra e Interior do Rio Grande do Sul.",
...
const servicesJsonLd = {
  "@context": "https://schema.org",
  "@graph": ["Pequenos Fretes", "Mudanças Residenciais", "Transporte de Móveis", "Frete Comercial e Empresarial", "Fretes para o Litoral", "Fretes Compartilhados", "Fretes Interior do RS"].map((name) => ({
    "@type": "Service",
    serviceType: name,
    provider: {
      "@type": "MovingCompany",
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Solicite seu frete ou mudança em segundos. Atendemos Canoas, Porto Alegre, litoral e interior do RS. Orçamento grátis pelo WhatsApp!"
    }, {
      name: "keywords",
      content: KEYWORDS
    }, {
      property: "og:title",
      content: "Central Fretes RS — Frete e Mudança em Canoas Porto Alegre Litoral e todo o RS"
    }, {
